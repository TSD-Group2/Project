        ...
        <div class="card custom-card mt-3">
            ...
            <input type="hidden" id="train_id" value="{{$train->id}}">
                ...
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                        ...
                        <input type="text" name="name" class="form-control" id="name" value="{{$train->name}}" placeholder="{{__('translate.enter_name')}}">
                    </div>
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                        <p class="mb-1">{{__('translate.code')}}</p>
                        <input type="text" name="code" class="form-control" id="code" value="{{$train->code}}" readonly>
                    </div>
...
<script type="text/javascript">
 $('#users-form').submit(function(e) {
    ...
    var formData = new FormData(this);
        ...
        $.ajax({
            url: "{{ route('train.update', ':id') }}".replace(':id', trainId),
            method: 'POST',
            data: formData,
            contentType: false,
            processData: false,
            ...
            success: function(response) {
                toastr.success('Train Updated Successfully');
